 ...
 */
public class JFrResultadoTabla extends javax.swing.JFrame {

    /**
     * Creates new form JFrResultadoTabla
     */
    DefaultTableModel modelo;

    public JFrResultadoTabla() {
        initComponents();
        ...
        ArrayList<ArrayList> info = prueba.pruebaColmogorov(numeros);
        String[] titulo = new String[]{"n", "Xo", "fo", "Distancia"};
        modelo.setColumnIdentifiers(titulo);
        jTablePruebas.setModel(modelo);
        String[] mostrar = new String[info.get(0).size()];
        for (int i = 0; i < info.get(0).size(); i++) {
            mostrar[0]=String.valueOf(i);
            mostrar[1]=info.get(0).get(i).toString();
            mostrar[2]=info.get(1).get(i).toString();
            mostrar[3]= info.get(2).get(i).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrResultadoTabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrResultadoTabla().setVisible(true);
            }
        });
    }
